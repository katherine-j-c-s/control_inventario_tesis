      ...
      <div className="flex flex-col sm:flex-row items-center gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted-foreground capitalize">
            {user?.puesto_laboral || 'Sin puesto asignado'}
          </p>
          <Button
            variant="outline"
            onClick={() => fileInputRef.current?.click()}
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) =>
                handleSelectChange("puesto_laboral", value)
              }
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="contol calidad ">
                  Control de Calidad
                </SelectItem>
                ...
                <SelectItem value="operador maquinaria">
                  Operador de maquinaria pesada
                </SelectItem>
                <SelectItem value="ingeniero">
                  Ingeniero de perforación
                </SelectItem>
                <SelectItem value="operador planta">
                  Operador de planta
                </SelectItem>
                <SelectItem value="analista stock">
                  Analista de control de stock
                </SelectItem>
                <SelectItem value="gerente admin">
